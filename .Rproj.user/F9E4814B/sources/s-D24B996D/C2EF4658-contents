...
ui <- fluidPage(
    ...
    # Application title
    titlePanel("Repeated Measures App"),
    ...
    sidebarLayout(
        sidebarPanel(
            ...
            numericInput('n_input', 'Number of tokens', 2, min = 0, max = Inf),
            submitButton("Submit"),
            br(),
            p(strong("Created by:"), 
              tags$a("Kyle Parrish", href="https://kparrish92.github.io"),
              br(), strong("Source code:"), 
              tags$a("Github", href="google.com"))
        ),
        
        # Show a plot of the generated distribution
        mainPanel(
          withSpinner(plotOutput("distPlot")),
          p("NOTE: The initial loading bar is will not finish loading. 
